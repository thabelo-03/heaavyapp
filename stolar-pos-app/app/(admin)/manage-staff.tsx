      ...
      <View style={styles.header}>
        <View style={styles.headerTop}>
          <View>
             ...
             <Text style={styles.subtitle}>{staff.length} Total Users</Text>
          </View>
        ...
        <View style={styles.filterContainer}>
          <TouchableOpacity 
            style={[styles.filterTab, roleFilter === 'all' && styles.filterTabActive]}
            onPress={() => setRoleFilter('all')}
          >
            <Text style={[styles.filterText, roleFilter === 'all' && styles.filterTextActive]}>All Staff</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.filterTab, roleFilter === 'manager' && styles.filterTabActive]}
            onPress={() => setRoleFilter('manager')}
          >
            <Text style={[styles.filterText, roleFilter === 'manager' && styles.filterTextActive]}>Managers</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.filterTab, roleFilter === 'cashier' && styles.filterTabActive]}
            onPress={() => setRoleFilter('cashier')}
          >
            <Text style={[styles.filterText, roleFilter === 'cashier' && styles.filterTextActive]}>Cashiers</Text>
          </TouchableOpacity>
        </View>
      </View>
